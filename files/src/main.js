...
const theme = {
    light: {
        ...
        light_inactive:           Color.parse('#f340'),
        light_active:             Color.parse('#f344'),
        wire_inactive:            new Color(.6,1,0),
        wire_active:              Color.parse('#f34'),
        segment_inactive:         Color.parse('#2af4'),
    ...
    dark: {
        ...
        light_inactive:           Color.parse('#f230'),
        light_active:             Color.parse('#f237'),
        wire_inactive:            new Color(.6,0,1),
        wire_active:              Color.parse('#f23'),
        segment_inactive:         Color.parse('#1473'),
        segment_active:           Color.parse('#f23'),
